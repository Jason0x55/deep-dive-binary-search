...
public class Main {
  ...
  public static void main(String[] args) {
    ...
    System.out.printf("Linear search time for %,d needles in haystack of size %,d = %.2f%n",
    ...
    System.out.printf("Binary search time for %,d needles in haystack of size %,d = %.2f%n",
        needles.length, haystack.length, (System.currentTimeMillis() - start) / 1000d);
  }
